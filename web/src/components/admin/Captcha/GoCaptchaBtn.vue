<template>
    <div class="wg-cap-btn" :style="`width:${width}; height:${height};`">
        <div class="wg-cap-btn__inner" :class="`wg-cap-active__${captStatus}`">
            <n-popover trigger="click" placement="top" raw @clickoutside="popoverUpdate" :show="popoverVisible">
                <go-captcha v-model="popoverVisible" width="300px" height="240px" :max-dot="maxDot"
                    :image-base64="imageBase64" :thumb-base64="thumbBase64" @refresh="handleRefreshEvent"
