...
declare const _sfc_main: import("vue").DefineComponent<{
    ...
    ContentBox: import("vue").DefineComponent<{
        ...
        like: (id: string) => void;
        user: import("vue").Ref<import("../interface").UserApi>;
        isUserInfo: boolean;
        ...
        CommentBox: import("vue").DefineComponent<{
            ...
            submit: (obj: import("../interface").CommentSubmitParam2) => void;
    ...
    ReplyBox: import("vue").DefineComponent<{
        ...
        replyPage: (parentId: string, pageNum: number, pageSize: number, finish: (comments: import("../interface").ReplyApi) => void) => void;
        showSize: number;
        page: boolean;
