...
export declare type TagsInstance = InstanceType<typeof tagsVue>;
export declare const UTags: import('../../util').SFCWithInstall<import("vue").DefineComponent<{
    classic: {
    ...
    props: {
        ...
        modelValue: import("./interface").TagApi[];
    };
    scrollbarRef: import("vue").Ref<any>;
    contextmenuRef: import("vue").Ref<any>;
    tagsList: import("vue").Ref<import("./interface").TagApi[]>;
    ...
    emit: {
        (e: "select", val: import("./interface").TagApi | undefined): void;
        (e: "refresh", val: import("./interface").TagApi): void;
        (e: "close", tag: import("./interface").TagApi): void;
        (e: "closeOther", tag: import("./interface").TagApi): void;
        (e: "closeAll"): void;
        (e: "fullScreen", tag: import("./interface").TagApi): void;
    };
    close: (val: number) => void;
    closeOther: (val?: import("./interface").TagApi | undefined) => void;
    onSubmit: (val: number, tag: import("./interface").TagApi) => void;
    onContextmenu: (v: import("./interface").TagApi, e: MouseEvent) => void;
    ContextMenu: import("vue").DefineComponent<{
        ...
        emit: (e: "submit", val: number, tag: import("./interface").TagApi) => void;
        openContextmenu: (v: import("./interface").TagApi) => void;
