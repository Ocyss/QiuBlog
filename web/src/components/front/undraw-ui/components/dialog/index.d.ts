...
export declare type DialogInstance = InstanceType<typeof dialogVue>;
export declare const UDialog: import('../../util').SFCWithInstall<import("vue").DefineComponent<{
    title: {
    ...
    emit: (e: "update:modelValue", val: boolean) => void;
