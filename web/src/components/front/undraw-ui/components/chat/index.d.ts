...
export declare type ChatInstance = InstanceType<typeof chatVue>;
export declare const UChat: import('../../util').SFCWithInstall<import("vue").DefineComponent<{
    data: {
    ...
    props: {
        data: import("./interface").ChatApi[];
        userId: number;
        emoji: import("..").EmojiApi;
    };
    active: import("vue").Ref<boolean>;
    content: import("vue").Ref<string>;
    messageRef: import("vue").Ref<any>;
    emit: (e: "submit", obj: import("./interface").ChatSubmitParam) => void;
    keydown: (e: KeyboardEvent | Event) => void;
    clear: () => void;
    submit: () => void;
    addEmoji: (val: string) => void;
    ...
    Message: import("vue").DefineComponent<{
        ...
        useEmojiParse: (allEmoji: import("..").Emoji, val: string) => string;
