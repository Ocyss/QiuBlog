...
export declare type NoticeBarInstance = InstanceType<typeof noticeBarVue>;
export declare const UNoticeBar: import('../../util').SFCWithInstall<import("vue").DefineComponent<{
    data: {
        type: null;
        required: true;
    };
